...
import { AvatarUploadState } from '@/lib/types/onboarding';
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            <div className="text-center">
              <h3 className="text-lg font-medium">Edit your avatar</h3>
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium">
              {isDragActive ? 'Drop your photo here' : 'Upload your avatar'}
            </p>
