-- Fix duplicate removal functions to match actual database schema
-- Use exact field names from the user requirements
...
-- Fix statistics function to match actual schema
