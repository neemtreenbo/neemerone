-- Fix RN commission details mapping in upload function to match actual database schema
-- Database uses: code, process_date, insured_name, policy_number, transaction_type, rn_premium_php, due_date, rate, year, rn_commission_php
