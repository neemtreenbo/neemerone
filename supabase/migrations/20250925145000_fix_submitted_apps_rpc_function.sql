-- Fix submitted apps upload function to use manual duplicate detection instead of ON CONFLICT constraint
-- This matches the pattern used by the other table-specific functions
