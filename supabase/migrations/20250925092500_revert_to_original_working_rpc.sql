-- Revert to the original working RPC function
-- This was working perfectly before we started "fixing" it
-- Only change: Keep the database constraint removals (for negative values)
